...
console.log(
  `First location: ${first}, Second location: ${second}, Others:`,
  remaining,
);
...
const { upper = "Alpha", middle = remaining.third, lower = "Omega" } = doorCode;
...
console.log(
  `Essential element number one: ${firstElement}, essential element number two: ${secondElement}`,
);
...
revealPath({ direction: "NNE", distance: "3 miles" });
...
mixPotion({ ingredient3: "Unicorn blood" });
...
castSpell(["Unicorn blood", "Phoenix feather"]);
