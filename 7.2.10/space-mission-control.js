...
function startMonitoring() {
  ...
  monitoringTaskID = setInterval(function () {
    console.log("Monitoring space station conditions every 2 seconds");
  }, 2000);
}
...
function scheduleMission() {
  ...
  // Add and run the pre-launch system check (fires after 1 seconds)
  addOneTimeTask(function () {
    console.log("Schedule the pre-launch system check");
  }, 1000);
  runOneTimeTasks();
  ...
  setTimeout(function () {
    stopMonitoring();
    console.log("Monitoring stopped. Preparing for countdown.");
  }, 5000);
